(function masteryAuraWeatherFeature() {
    ...
    function registerUnlockedEventCosmetics() {
        if (typeof profileBackgrounds !== 'undefined') {
            const backgrounds = [
                { id:'firework-festival', name:'Firework Festival', icon:'assets/event-vault/firework-festival.png', css:'url("assets/event-vault/themes/firework-festival-menu-v2.png") center/cover,linear-gradient(145deg,#080426,#401454)', lobbyCss:'radial-gradient(circle at 50% 16%,rgba(255,214,79,.18),transparent 24rem),url("assets/event-vault/themes/firework-festival-menu-v2.png") center/cover fixed,#08031f', cardArtworkCss:'url("assets/event-vault/themes/firework-festival-menu-v2.png") center/cover', panelCss:'linear-gradient(145deg,rgba(42,13,67,.97),rgba(8,6,38,.99))', buttonCss:'linear-gradient(145deg,#7a2fb2,#d6932e)', accent:'#ffd975', forceArtwork:true },
                { id:'boss-breaker', name:'Boss Breaker Arena', icon:'assets/event-vault/boss-breaker.png', css:'url("assets/event-vault/themes/boss-breaker-menu-v2.png") center/cover,linear-gradient(145deg,#151012,#661c18)', lobbyCss:'radial-gradient(circle at 50% 0,rgba(255,89,48,.16),transparent 27rem),url("assets/event-vault/themes/boss-breaker-menu-v2.png") center/cover fixed,#170906', cardArtworkCss:'url("assets/event-vault/themes/boss-breaker-menu-v2.png") center/cover', panelCss:'linear-gradient(145deg,rgba(78,18,13,.98),rgba(20,8,8,.99))', buttonCss:'linear-gradient(145deg,#d64622,#651713)', accent:'#ff9d48', forceArtwork:true },
                { id:'x-marks-the-spot', name:'X Marks The Spot', icon:'assets/event-vault/x-marks-the-spot.png', css:'url("assets/event-vault/themes/x-marks-the-spot-menu-v2.png") center/cover,linear-gradient(145deg,#0c4661,#8d5d18)', lobbyCss:'radial-gradient(circle at 72% 20%,rgba(255,224,123,.16),transparent 26rem),url("assets/event-vault/themes/x-marks-the-spot-menu-v2.png") center/cover fixed,#082e43', cardArtworkCss:'url("assets/event-vault/themes/x-marks-the-spot-menu-v2.png") center/cover', panelCss:'linear-gradient(145deg,rgba(18,70,78,.98),rgba(55,32,10,.99))', buttonCss:'linear-gradient(145deg,#bd7d27,#185f70)', accent:'#ffe38a', forceArtwork:true }
            ];
